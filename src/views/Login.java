...
public class Login extends JFrame {
    ...
    private void Login() {
        ...
        validaUsuario(txtUsuario.getText(), contra);      
    }
    ...
    public void validaUsuario(String usuario, String contrasenia) {

        try {
            ResultSet rs = null;
            PreparedStatement ps = null;

            ConnectionFactory objetoConexion = new ConnectionFactory();

            String consulta = "select * from Usuarios where usuario =? and contrasena=?;";
            ps = objetoConexion.recuperarConexion().prepareStatement(consulta);
